        ...
        <div className="pr-4 pl-4 md:w-[65%] sm:[90%] mx-auto">
            ...
            <div className="grid grid-cols-[60%_40%]">
                <div>
                    ...
                    <p className="mb-4">I’m a full-stack developer who acquired my technical skills through college, coding bootcamps, YouTube, and LaunchCode - a nonprofit coding bootcamp.</p>
            ...
            <p className="mb-4 mx-auto w-[80%]">Additionally, I am currently in college to aquire a degree in Software Development and I enjoy playing indoor volleyball in my freetime.</p>
        </div>
    );
};
