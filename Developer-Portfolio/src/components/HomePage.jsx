...
const HomePage = () => {
    ...
    return (
        <div className="bg-[#2d2d30]">
            ...
            >
                <div className={`grid md:grid-cols-[60%_40%] sm:grid-cols-1 w-full font-bold text-white  `}>
                    <div
                    ...
                    >
                        ...
                        <p className="text-2xl mt-2 font-semibold text-center">Software Engineer | Full Stack Developer | Tech Enthusiast</p>
                        ...
                        <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-10 mx-auto pl-4 pr-4 md:mr-20 md:ml-10">
                            <div className="grid-cols-1">
                                ...
                                <p className="text-lg font-light mt-2">
                                    ...
                                    industry.
                                    <Link to="/aboutme" className="ml-2 inline-flex items-center hover:underline hover:cursor-pointer">
                                        {' '}
                            ...
                            <div className="grid-cols-2">
                                ...
                                <p className="text-lg font-light mt-2">
                                    ...
                                    <Link to="/aboutme#mycareer" className="ml-2 inline-flex items-center hover:underline">
                                        {' '}
                                        Learn More <IoMdArrowRoundForward />{' '}
                                    </Link>
                                </p>
                ...
                <div onClick={scrollToSection} className="flex justify-center animate-bounce mt-10">
