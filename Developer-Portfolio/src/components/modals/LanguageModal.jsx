...
const LanguageModal = ({ onClose, language, onPrev, onNext }) => {
    ...
    return (
        <div ref={modalRef} onClick={closeModal} className="flex fixed inset-0 backdrop-blur-3xl items-center justify-center z-50">
            <div className="grid grid-cols-[5%_90%_5%] p-6 rounded-lg shadow-xl w-[90%] md:w-[75%] border-black text-zinc-100 max-h-screen overflow-y-auto">
                <button onClick={onPrev} className="flex items-center justify-center">
                    <RiArrowLeftWideLine size="3em" className="cursor-pointer hover:scale-110 transition-transform duration-200" />
                </button>
                ...
                <button onClick={onNext} className="flex items-center justify-center">
                    <RiArrowRightWideLine size="3em" className="cursor-pointer hover:scale-110 transition-transform duration-200" />
                </button>
            </div>
        </div>
    );
